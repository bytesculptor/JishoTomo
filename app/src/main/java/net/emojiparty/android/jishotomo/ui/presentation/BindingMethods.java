...
public class BindingMethods {
    ...
    public static void setCrossReferenceLinks(View view,
    ...
    public static void setJlptPill(View view, Integer jlptLevel) {
        if (jlptLevel != null) {
    ...
    public static void setTextWithJapanese(View view,
                                           String text) {
        if (text == null) {
            text = "";
        }
